...
(function(factory) {
  ...
  var escapeSelector = $.ui.escapeSelector = /* @__PURE__ */ function() {
  ...
  var intersect = $.ui.intersect = /* @__PURE__ */ function() {
  ...
  if ($.uiBackCompat !== false) {
    ...
    $.fn.button = /* @__PURE__ */ function(orig) {
      return function() {
  ...
  $.extend(Datepicker.prototype, {
    ...
    _attachments: function(input, inst) {
      ...
      if (showOn === "button" || showOn === "both") {
        ...
        inst.trigger = $(this._get(inst, "buttonImageOnly") ? $("<img/>").addClass(this._triggerClass).attr({ src: buttonImage, alt: buttonText, title: buttonText }) : $("<button type='button'></button>").addClass(this._triggerClass).html(!buttonImage ? buttonText : $("<img/>").attr(
